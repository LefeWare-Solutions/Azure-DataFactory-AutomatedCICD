...
$environment = "stg"
$orgNameShort = "lws" 
$resourceGroupName = "$($orgNameShort)-$($locationShort)-$($environment)-dfcicd-rg"
...
$srcStorageAccountName = "$($orgNameShort)$($locationShort)$($environment)dfcicdstg1"
$destStorageAccountName = "$($orgNameShort)$($locationShort)$($environment)dfcicdstg2"
...
#Create KeyVault
$keyVaultName = "$($orgNameShort)$($locationShort)$($environment)dfcicdkeyvault"
...
$adfName = "$($orgNameShort)-$($locationShort)-$($environment)-dfcicd-adf"
